package com.android.realize.custom.assembly.seekBar.view;
...
import com.android.realize.custom.assembly.seekBar.data.UiUtils;
...
public class CustomLoadingView1 extends View {
    private static final String TAG = "CustomLoadingView1";
    // 淡白色
    ...
    public CustomLoadingView1(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void drawProgressAndLeafs(Canvas canvas) {
        ...
        if (mCurrentProgressPosition < mArcRadius) {
            UiLog.i(TAG, "mProgress = " + mProgress + "---mCurrentProgressPosition = "
            ...
            UiLog.i(TAG, "startAngle = " + startAngle);
            canvas.drawArc(mArcRectF, startAngle, sweepAngle, false, mOrangePaint);
        } else {
            UiLog.i(TAG, "mProgress = " + mProgress + "---transfer-----mCurrentProgressPosition = "
                    + mCurrentProgressPosition
                    + "--mArcProgressWidth" + mArcRadius);
            // 1.绘制white RECT
            // 2.绘制Orange ARC
    ...
    private void drawLeafs(Canvas canvas) {
        ...
        for (int i = 0; i < mLeafInfos.size(); i++) {
            ...
            if (currentTime > leaf.startTime && leaf.startTime != 0) {
                ...
                UiLog.i(TAG, "left.x = " + leaf.x + "--leaf.y=" + leaf.y);
    ...
    private int getLocationY(Leaf leaf) {
        ...
        UiLog.i(TAG, "---a = " + a + "---w = " + w + "--leaf.x = " + leaf.x);
